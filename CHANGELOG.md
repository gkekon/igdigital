...
**Μέτρηση (Lighthouse, κινητό, ίδιες ρυθμίσεις):** live πριν **80** (FCP 3,4 δευτ. · LCP 3,8 · SI 4,0) → τοπικά μετά **98** (FCP 1,9 · LCP 2,1 · TBT 0 · SI 2,1). Το τοπικό είναι αισιόδοξο (δεν έχει καθυστέρηση δικτύου προς σέρβερ) — μετά το deploy το ξαναμετράμε, περιμένουμε 90+.
